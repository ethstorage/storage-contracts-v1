...
/// @custom:proxied
/// @title EthStorageContractL2Base
/// @notice EthStorage contract that will be deployed on L2, and uses L1Block contract to mine.
abstract contract EthStorageContractL2Base is EthStorageContract {
    ...
    /// @notice Constructs the EthStorageContractL2Base contract.
    constructor(
    ...
    function _checkAppend(uint256 _batchSize) internal virtual override {
        ...
        require(msg.value >= totalPayment - sgtCharged, "EthStorageContractL2Base: not enough batch payment");
        ...
        returns (bytes32)
    {
        ...
        require(bh != bytes32(0), "EthStorageContractL2Base: failed to obtain blockhash");
    ...
    function _checkUpdateLimit(uint256 _updateSize) internal override {
        ...
        require(blobsUpdated + _updateSize <= UPDATE_LIMIT, "EthStorageContractL2Base: exceeds update rate limit");
