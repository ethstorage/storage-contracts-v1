...
contract EthStorageContractM2L2 is EthStorageContractM2 {
        ...
        returns (bytes32)
    {
        ...
        require(bh != bytes32(0), "EthStorageContractM2L2: failed to obtain blockhash");
    ...
    function _checkUpdateLimit(uint256 _updateSize) internal override {
        ...
        require(blobsUpdated + _updateSize <= UPDATE_LIMIT, "EthStorageContractM2L2: exceeds update rate limit");
