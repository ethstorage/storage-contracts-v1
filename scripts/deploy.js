...
async function deployContract() {
    ...
    const storageContract = await hre.upgrades.deployProxy(StorageContract, [
        [
...
async function updateContract() {
    let StorageContract = await hre.ethers.getContractFactory("TestEthStorageContractKZG");
    const contract = await hre.upgrades.upgradeProxy(storageContractProxy, StorageContract);
    console.log("StorageContract upgraded", await contract.getAddress());
}
